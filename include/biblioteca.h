...
public:
    ...
    bool verificar_existencia_pedido(string matricula, Livro* l, list<PedidoReserva*> lista_pedidos);
    void ver_informacoes_livro() const; ///temporario para testar as alteracoes na matriz.
    Livro* mostrar_exemplar_todos_livros(); /// mostra um livro de cada e retorna o livro escolhido.
