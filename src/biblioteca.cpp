//// FUNÇAO OREDNAR LISTA PEDIDOS() E CHAMAR ELA EM CRIAR PEDIDO()
///fazer tratamento de excessao para n reservar livros indisponiveis
///
//
...
void Biblioteca::adicionar_livro(Livro* novo_livro) {
    bool existe = 0 ;
    /// Verificar se já existe uma lista com um livro com este nome
    ...
    //ordena
        ...
        // Ordenar a lista de listas com base no comparador personalizado
        todos_livros.sort(compararNomeDoPrimeiroLivro);
}
///----------------------------------------------------------------------------------------------------------
...
Livro* Biblioteca::mostrar_exemplar_todos_livros() {
    ...
    for ( auto& lista : todos_livros) {
        ...
        /// tratamento de excessao para caso seja menor que 0;
    }
...
PedidoReserva* Biblioteca::verificar_pedidos_renovar_emprestimo(){
    ...
    if(pedidos_renovar_emprestimo.empty() or tem_pedido == false){
        throw runtime_error("\033[32mNao ha pedidos de renovar emprestimo!\033[0m");
        return nullptr;
    }
